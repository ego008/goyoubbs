...
`)
//line views/ybs/base.qtpl:290
	if len(p.SiteCf.FooterPartHtml) > 0 {
//line views/ybs/base.qtpl:290
		qw422016.N().S(`
`)
//line views/ybs/base.qtpl:291
		qw422016.N().S(p.SiteCf.FooterPartHtml)
//line views/ybs/base.qtpl:291
		qw422016.N().S(`
`)
//line views/ybs/base.qtpl:292
	}
//line views/ybs/base.qtpl:292
	qw422016.N().S(`

`)
//line views/ybs/base.qtpl:294
}
