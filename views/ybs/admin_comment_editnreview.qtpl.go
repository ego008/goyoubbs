...
//line views/ybs/admin_comment_editnreview.qtpl:1
package ybs
...
<div class="index">
    `)
//line views/ybs/admin_comment_editnreview.qtpl:4
	if p.PageName == "admin_comment_review" && len(p.DefaultComment.Content) == 0 {
//line views/ybs/admin_comment_editnreview.qtpl:4
		qw422016.N().S(`
        <h1>没有 `)
//line views/ybs/admin_comment_editnreview.qtpl:5
		qw422016.E().S(p.Title)
//line views/ybs/admin_comment_editnreview.qtpl:5
		qw422016.N().S(`</h1>
    `)
//line views/ybs/admin_comment_editnreview.qtpl:6
	} else {
//line views/ybs/admin_comment_editnreview.qtpl:6
		qw422016.N().S(`
    <h1>`)
//line views/ybs/admin_comment_editnreview.qtpl:7
		qw422016.E().S(p.Title)
//line views/ybs/admin_comment_editnreview.qtpl:7
		qw422016.N().S(`</h1>
    <p><a href="/t/`)
//line views/ybs/admin_comment_editnreview.qtpl:8
...
//line views/ybs/admin_comment_editnreview.qtpl:8
		qw422016.N().S(`</a></p>
    <p>by `)
//line views/ybs/admin_comment_editnreview.qtpl:9
...
//line views/ybs/admin_comment_editnreview.qtpl:13
