// Code generated by qtc from "admin_user.qtpl". DO NOT EDIT.
// See https://github.com/valyala/quicktemplate for details.

//line views/ybs/admin_user.qtpl:1
package ybs
...
<div class="index">
    ...
    <h1>`)
//line views/ybs/admin_user.qtpl:4
...
//line views/ybs/admin_user.qtpl:4
    ...
    <form action="" method="post" class="pure-form pure-form-stacked">
        <fieldset>
            <legend>`)
//line views/ybs/admin_user.qtpl:12
	qw422016.E().S(p.Act)
//line views/ybs/admin_user.qtpl:12
	qw422016.N().S(` 用户</legend>
            `)
//line views/ybs/admin_user.qtpl:13
	if p.User.ID > 0 {
//line views/ybs/admin_user.qtpl:13
		qw422016.N().S(`
...
//line views/ybs/admin_user.qtpl:30
		qw422016.N().DUL(p.User.ID)
//line views/ybs/admin_user.qtpl:30
		qw422016.N().S(`");
            ...
            `)
//line views/ybs/admin_user.qtpl:42
	}
//line views/ybs/admin_user.qtpl:42
	qw422016.N().S(`
            ...
            <p>Flag:
            `)
//line views/ybs/admin_user.qtpl:45
	for _, item := range p.FlagLst {
//line views/ybs/admin_user.qtpl:45
		qw422016.N().S(`
            <a href="?flag=`)
//line views/ybs/admin_user.qtpl:46
...
//line views/ybs/admin_user.qtpl:46
		qw422016.N().S(`</a>,
            `)
//line views/ybs/admin_user.qtpl:47
	}
//line views/ybs/admin_user.qtpl:47
	qw422016.N().S(`
            </p>
...
//line views/ybs/admin_user.qtpl:53
	qw422016.E().S(p.User.Name)
//line views/ybs/admin_user.qtpl:53
	qw422016.N().S(`" required>
                ...
                <div class="pure-u-1 pure-u-sm-1-6">
                    ...
                    <select id="select-nid" name="Flag">
                        `)
//line views/ybs/admin_user.qtpl:64
	for _, item := range p.FlagLst {
//line views/ybs/admin_user.qtpl:64
		qw422016.N().S(`
                        <option value="`)
//line views/ybs/admin_user.qtpl:65
		qw422016.N().D(item.Flag)
//line views/ybs/admin_user.qtpl:65
		qw422016.N().S(`" `)
//line views/ybs/admin_user.qtpl:65
...
//line views/ybs/admin_user.qtpl:65
		qw422016.N().S(`</option>
                        `)
//line views/ybs/admin_user.qtpl:66
	}
//line views/ybs/admin_user.qtpl:66
	qw422016.N().S(`
                    </select>
...
//line views/ybs/admin_user.qtpl:74
...
//line views/ybs/admin_user.qtpl:75
...
//line views/ybs/admin_user.qtpl:75
    ...
    <ul>
        ...
        `)
//line views/ybs/admin_user.qtpl:89
	for _, v := range p.UserLst {
//line views/ybs/admin_user.qtpl:89
		qw422016.N().S(`
        <li class="bot-line">
            `)
//line views/ybs/admin_user.qtpl:91
		qw422016.N().DUL(v.ID)
//line views/ybs/admin_user.qtpl:91
...
//line views/ybs/admin_user.qtpl:91
        ...
        `)
//line views/ybs/admin_user.qtpl:93
	}
//line views/ybs/admin_user.qtpl:93
	qw422016.N().S(`
    </ul>
...
`)
//line views/ybs/admin_user.qtpl:98
}
