...
//line views/admin/admin_link.qtpl:1
package admin
...
<div class="index">
    ...
    <h1>`)
//line views/admin/admin_link.qtpl:4
...
//line views/admin/admin_link.qtpl:4
    ...
    <form action="" method="post" class="pure-form pure-form-stacked">
        <fieldset>
            <legend>`)
//line views/admin/admin_link.qtpl:8
	qw422016.E().S(p.Act)
//line views/admin/admin_link.qtpl:8
...
//line views/admin/admin_link.qtpl:15
...
//line views/admin/admin_link.qtpl:20
...
//line views/admin/admin_link.qtpl:25
...
//line views/admin/admin_link.qtpl:25
    ...
    <ul>
        ...
        `)
//line views/admin/admin_link.qtpl:40
	for _, v := range p.LinkLst {
//line views/admin/admin_link.qtpl:40
		qw422016.N().S(`
        <li class="bot-line">
            `)
//line views/admin/admin_link.qtpl:42
		qw422016.N().DUL(v.ID)
//line views/admin/admin_link.qtpl:42
...
//line views/admin/admin_link.qtpl:42
        ...
        `)
//line views/admin/admin_link.qtpl:44
	}
//line views/admin/admin_link.qtpl:44
	qw422016.N().S(`
    </ul>
...
`)
//line views/admin/admin_link.qtpl:50
}
