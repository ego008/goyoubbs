// Code generated by qtc from "admin_comment_editnreview.qtpl". DO NOT EDIT.
// See https://github.com/valyala/quicktemplate for details.

//line views/admin/admin_comment_editnreview.qtpl:1
package admin
...
<div class="index">
    `)
//line views/admin/admin_comment_editnreview.qtpl:4
	if p.PageName == "admin_comment_review" && len(p.DefaultComment.Content) == 0 {
//line views/admin/admin_comment_editnreview.qtpl:4
		qw422016.N().S(`
        <h1>没有 `)
//line views/admin/admin_comment_editnreview.qtpl:5
		qw422016.E().S(p.Title)
//line views/admin/admin_comment_editnreview.qtpl:5
		qw422016.N().S(`</h1>
    `)
//line views/admin/admin_comment_editnreview.qtpl:6
	} else {
//line views/admin/admin_comment_editnreview.qtpl:6
		qw422016.N().S(`
    <h1>`)
//line views/admin/admin_comment_editnreview.qtpl:7
		qw422016.E().S(p.Title)
//line views/admin/admin_comment_editnreview.qtpl:7
		qw422016.N().S(`</h1>
    <p><a href="/t/`)
//line views/admin/admin_comment_editnreview.qtpl:8
...
//line views/admin/admin_comment_editnreview.qtpl:8
		qw422016.N().S(`</a></p>
    <p>by `)
//line views/admin/admin_comment_editnreview.qtpl:9
...
//line views/admin/admin_comment_editnreview.qtpl:13
...
//line views/admin/admin_comment_editnreview.qtpl:13
		qw422016.N().S(`</textarea>
            ...
            <div class="fleft pure-button-group">
                ...
                `)
//line views/admin/admin_comment_editnreview.qtpl:20
		if p.PageName == "admin_comment_review" {
//line views/admin/admin_comment_editnreview.qtpl:20
			qw422016.N().S(`
                <a href="?act=del" class="pure-button button-warning fr">直接删除</a>
                `)
//line views/admin/admin_comment_editnreview.qtpl:22
		}
//line views/admin/admin_comment_editnreview.qtpl:22
		qw422016.N().S(`
            </div>
...
//line views/admin/admin_comment_editnreview.qtpl:63
...
//line views/admin/admin_comment_editnreview.qtpl:63
		qw422016.N().S(`}), function(data){
                ...
                if(obj.Code === 200) {
                    `)
//line views/admin/admin_comment_editnreview.qtpl:70
		if p.GoBack {
//line views/admin/admin_comment_editnreview.qtpl:70
			qw422016.N().S(`
                    window.location.href = "/t/`)
//line views/admin/admin_comment_editnreview.qtpl:71
			qw422016.N().DUL(p.DefaultComment.TopicId)
//line views/admin/admin_comment_editnreview.qtpl:71
			qw422016.N().S(`#r`)
//line views/admin/admin_comment_editnreview.qtpl:71
...
//line views/admin/admin_comment_editnreview.qtpl:71
			qw422016.N().S(`";
                    return false;
                    `)
//line views/admin/admin_comment_editnreview.qtpl:73
		}
//line views/admin/admin_comment_editnreview.qtpl:73
		qw422016.N().S(`
                    `)
//line views/admin/admin_comment_editnreview.qtpl:74
		if p.PageName == "admin_comment_review" {
//line views/admin/admin_comment_editnreview.qtpl:74
			qw422016.N().S(`
                    window.location.href = "/admin/comment/review";
                    `)
//line views/admin/admin_comment_editnreview.qtpl:76
		} else {
//line views/admin/admin_comment_editnreview.qtpl:76
			qw422016.N().S(`
                    if(data.Tid > 0){
                    ...
                    `)
//line views/admin/admin_comment_editnreview.qtpl:82
		}
//line views/admin/admin_comment_editnreview.qtpl:82
		qw422016.N().S(`
                    return false;
...
//line views/admin/admin_comment_editnreview.qtpl:85
...
//line views/admin/admin_comment_editnreview.qtpl:85
    ...
    `)
//line views/admin/admin_comment_editnreview.qtpl:142
	}
//line views/admin/admin_comment_editnreview.qtpl:142
	qw422016.N().S(`
...
`)
//line views/admin/admin_comment_editnreview.qtpl:146
}
